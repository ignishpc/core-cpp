...
class ICacheContextModuleIfSingletonFactory : virtual public ICacheContextModuleIfFactory {
 public:
  ...
  virtual ICacheContextModuleIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(ICacheContextModuleIf* /* handler */) override {}
...
class ICacheContextModuleNull : virtual public ICacheContextModuleIf {
 public:
  ...
  void loadContextAsVariable(const int64_t /* id */, const std::string& /* name */) override {
    return;
  }
  void cache(const int64_t /* id */, const int8_t /* level */) override {
    return;
  }
  void loadCache(const int64_t /* id */) override {
    return;
  }
};
...
class ICacheContextModule_saveContext_args {
 public:
  ...
  ICacheContextModule_saveContext_args(const ICacheContextModule_saveContext_args&) noexcept;
  ICacheContextModule_saveContext_args& operator=(const ICacheContextModule_saveContext_args&) noexcept;
  ICacheContextModule_saveContext_args() noexcept {
  }
...
class ICacheContextModule_saveContext_result {
 public:
  ...
  ICacheContextModule_saveContext_result() noexcept
                                         : success(0) {
  }
...
class ICacheContextModule_clearContext_args {
 public:
  ...
  ICacheContextModule_clearContext_args(const ICacheContextModule_clearContext_args&) noexcept;
  ICacheContextModule_clearContext_args& operator=(const ICacheContextModule_clearContext_args&) noexcept;
  ICacheContextModule_clearContext_args() noexcept {
  }
...
class ICacheContextModule_clearContext_result {
 public:
  ...
  ICacheContextModule_clearContext_result() noexcept {
  }
...
class ICacheContextModule_loadContext_args {
 public:
  ...
  ICacheContextModule_loadContext_args(const ICacheContextModule_loadContext_args&) noexcept;
  ICacheContextModule_loadContext_args& operator=(const ICacheContextModule_loadContext_args&) noexcept;
  ICacheContextModule_loadContext_args() noexcept
                                       : id(0) {
  }
...
class ICacheContextModule_loadContext_result {
 public:
  ...
  ICacheContextModule_loadContext_result() noexcept {
  }
...
class ICacheContextModule_loadContextAsVariable_args {
 public:
  ...
  ICacheContextModule_loadContextAsVariable_args() noexcept
                                                 : id(0),
                                                   name() {
  }
...
class ICacheContextModule_loadContextAsVariable_result {
 public:
  ...
  ICacheContextModule_loadContextAsVariable_result() noexcept {
  }
...
class ICacheContextModule_cache_args {
 public:
  ...
  ICacheContextModule_cache_args(const ICacheContextModule_cache_args&) noexcept;
  ICacheContextModule_cache_args& operator=(const ICacheContextModule_cache_args&) noexcept;
  ICacheContextModule_cache_args() noexcept
                                 : id(0),
                                   level(0) {
  }
...
class ICacheContextModule_cache_result {
 public:
  ...
  ICacheContextModule_cache_result() noexcept {
  }
...
class ICacheContextModule_loadCache_args {
 public:
  ...
  ICacheContextModule_loadCache_args(const ICacheContextModule_loadCache_args&) noexcept;
  ICacheContextModule_loadCache_args& operator=(const ICacheContextModule_loadCache_args&) noexcept;
  ICacheContextModule_loadCache_args() noexcept
                                     : id(0) {
  }
...
class ICacheContextModule_loadCache_result {
 public:
  ...
  ICacheContextModule_loadCache_result() noexcept {
  }
...
class ICacheContextModuleProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  ICacheContextModuleProcessorFactory(const ::std::shared_ptr< ICacheContextModuleIfFactory >& handlerFactory) noexcept :
