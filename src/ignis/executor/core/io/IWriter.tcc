...
struct ignis::executor::core::io::IWriterType<bool> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_BOOL); }

    inline void operator()(protocol::IProtocol &protocol, const bool &obj) { protocol.writeBool(obj); }
};

template<>
struct ignis::executor::core::io::IWriterType<int8_t> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_I08); }

    inline void operator()(protocol::IProtocol &protocol, const int8_t &obj) { protocol.writeByte(obj); }
};
...
struct ignis::executor::core::io::IWriterType<uint8_t> {
    ...
    inline void operator()(protocol::IProtocol &protocol, const uint8_t &obj) { protocol.writeByte((int8_t &) obj); }
};

template<>
struct ignis::executor::core::io::IWriterType<int16_t> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_I16); }

    inline void operator()(protocol::IProtocol &protocol, const int16_t &obj) { protocol.writeI16(obj); }
};

template<>
struct ignis::executor::core::io::IWriterType<uint16_t> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_I32); }

    inline void operator()(protocol::IProtocol &protocol, const uint16_t &obj) { protocol.writeI16((int16_t &) obj); }
};
...
struct ignis::executor::core::io::IWriterType<int32_t> {
    ...
    inline void operator()(protocol::IProtocol &protocol, const int32_t &obj) { protocol.writeI32(obj); }
};

template<>
struct ignis::executor::core::io::IWriterType<uint32_t> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_I64); }

    inline void operator()(protocol::IProtocol &protocol, const uint32_t &obj) { protocol.writeI32((int32_t &) obj); }
};
...
struct ignis::executor::core::io::IWriterType<int64_t> {
    ...
    inline void operator()(protocol::IProtocol &protocol, const int64_t &obj) { protocol.writeI64(obj); }
};
...
struct ignis::executor::core::io::IWriterType<uint64_t> {
    ...
    inline void operator()(protocol::IProtocol &protocol, const uint64_t &obj) { protocol.writeI64((int64_t &) obj); }
};

template<>
struct ignis::executor::core::io::IWriterType<float> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_DOUBLE); }

    inline void operator()(protocol::IProtocol &protocol, const float &obj) { protocol.writeDouble(obj); }
};
...
struct ignis::executor::core::io::IWriterType<double> {
    ...
    inline void operator()(protocol::IProtocol &protocol, const double &obj) { protocol.writeDouble(obj); }
};

template<>
struct ignis::executor::core::io::IWriterType<std::string> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_STRING); }

    inline void operator()(protocol::IProtocol &protocol, const std::string &obj) { protocol.writeString(obj); }
};

template<typename _Tp, typename _Alloc>
struct ignis::executor::core::io::IWriterType<std::vector<_Tp, _Alloc>> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_LIST); }
    ...
    inline void operator()(protocol::IProtocol &protocol, const std::vector<_Tp, _Alloc> &obj) {
        ...
        for (const auto &elem : obj) { writer(protocol, elem); }
    }
};
...
struct ignis::executor::core::io::IWriterType<std::vector<bool, _Alloc>> {
    ...
    inline void operator()(protocol::IProtocol &protocol, const std::vector<bool, _Alloc> &obj) {
        ...
        writer.writeType(protocol);
        for (const bool elem : obj) { writer(protocol, elem); }
    }
};
...
struct ignis::executor::core::io::IWriterType<std::vector<std::pair<_T1, _T2>, _Alloc>> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_PAIR_LIST); }

    inline void operator()(protocol::IProtocol &protocol, const std::vector<std::pair<_T1, _T2>, _Alloc> &obj) {
        writeSizeAux(protocol, obj.size());
...
struct ignis::executor::core::io::IWriterType<std::vector<uint8_t, _Alloc>> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_BINARY); }

    inline void operator()(protocol::IProtocol &protocol, const std::vector<uint8_t, _Alloc> &obj) {
        auto size = obj.size();
        writeSizeAux(protocol, size);
        auto data = obj.data();
        for (decltype(size) i = 0; i < size; i++) { protocol.writeByte((int8_t &) data[i]); }
    }
};
...
struct ignis::executor::core::io::IWriterType<std::list<_Tp, _Alloc>> {
    ...
    inline void operator()(protocol::IProtocol &protocol, const std::list<_Tp, _Alloc> &obj) {
        ...
        auto writer = IWriterType<_Tp>();
        writer.writeType(protocol);
        for (auto it = obj.begin(); it != obj.end(); it++) { writer(protocol, *it); }
    }
};
...
struct ignis::executor::core::io::IWriterType<std::forward_list<_Tp, _Alloc>> {
    ...
    inline void operator()(protocol::IProtocol &protocol, const std::forward_list<_Tp, _Alloc> &obj) {
        size_t size = 0;
        for (auto it = obj.begin(); it != obj.end(); it++) { size++; }
        writeSizeAux(protocol, size);
        auto writer = IWriterType<_Tp>();
        writer.writeType(protocol);
        for (auto it = obj.begin(); it != obj.end(); it++) { writer(protocol, *it); }
...
struct ignis::executor::core::io::IWriterType<std::set<_Key, _Compare, _Alloc>> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_SET); }
...
struct ignis::executor::core::io::IWriterType<std::unordered_set<_Value, _Hash, _Pred, _Alloc>> {
    ...
    inline void operator()(protocol::IProtocol &protocol, const std::unordered_set<_Value, _Hash, _Pred, _Alloc> &obj) {
        writeSizeAux(protocol, obj.size());
...
struct ignis::executor::core::io::IWriterType<std::map<_Key, _Tp, _Compare, _Alloc>> {
    inline void writeType(protocol::IProtocol &protocol) { writeTypeAux(protocol, IEnumTypes::I_MAP); }
...
struct ignis::executor::core::io::IWriterType<std::unordered_map<_Key, _Tp, _Hash, _Pred, _Alloc>> {
    ...
    inline void operator()(protocol::IProtocol &protocol,
                           const std::unordered_map<_Key, _Tp, _Hash, _Pred, _Alloc> &obj) {
        writeSizeAux(protocol, obj.size());
        auto w_key = IWriterType<_Key>();
        auto w_value = IWriterType<_Tp>();
        w_key.writeType(protocol);
...
struct ignis::executor::core::io::IWriterType<_Tp *> {
    inline void writeType(protocol::IProtocol &protocol) { writer.writeType(protocol); }

    inline void operator()(protocol::IProtocol &protocol, const _Tp *obj) { writer(protocol, *obj); }
...
struct ignis::executor::core::io::IWriterType<std::shared_ptr<_Tp>> {
    ...
    inline void operator()(protocol::IProtocol &protocol, const std::shared_ptr<_Tp> &obj) { writer(protocol, *obj); }
