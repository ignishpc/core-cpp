...
class IPropertiesServiceIfSingletonFactory : virtual public IPropertiesServiceIfFactory {
 public:
  ...
  virtual IPropertiesServiceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(IPropertiesServiceIf* /* handler */) override {}
...
class IPropertiesServiceNull : virtual public IPropertiesServiceIf {
 public:
  ...
  int64_t newInstance() override {
    int64_t _return = 0;
    return _return;
  }
  int64_t newInstance2(const int64_t /* id */) override {
    int64_t _return = 0;
    return _return;
  }
  void setProperty(std::string& /* _return */, const int64_t /* id */, const std::string& /* key */, const std::string& /* value */) override {
    return;
  }
  void getProperty(std::string& /* _return */, const int64_t /* id */, const std::string& /* key */) override {
    return;
  }
  void rmProperty(std::string& /* _return */, const int64_t /* id */, const std::string& /* key */) override {
    return;
  }
  bool contains(const int64_t /* id */, const std::string& /* key */) override {
    bool _return = false;
    return _return;
  }
  void toMap(std::map<std::string, std::string> & /* _return */, const int64_t /* id */, const bool /* defaults */) override {
    return;
  }
  void fromMap(const int64_t /* id */, const std::map<std::string, std::string> & /* map_ */) override {
    return;
  }
  void load(const int64_t /* id */, const std::string& /* path */) override {
    return;
  }
  void store(const int64_t /* id */, const std::string& /* path */) override {
    return;
  }
  void clear(const int64_t /* id */) override {
    return;
  }
};
...
class IPropertiesService_newInstance_args {
 public:
  ...
  IPropertiesService_newInstance_args(const IPropertiesService_newInstance_args&) noexcept;
  IPropertiesService_newInstance_args& operator=(const IPropertiesService_newInstance_args&) noexcept;
  IPropertiesService_newInstance_args() noexcept {
  }
...
class IPropertiesService_newInstance_result {
 public:
  ...
  IPropertiesService_newInstance_result() noexcept
                                        : success(0) {
  }
...
class IPropertiesService_newInstance2_args {
 public:
  ...
  IPropertiesService_newInstance2_args(const IPropertiesService_newInstance2_args&) noexcept;
  IPropertiesService_newInstance2_args& operator=(const IPropertiesService_newInstance2_args&) noexcept;
  IPropertiesService_newInstance2_args() noexcept
                                       : id(0) {
  }
...
class IPropertiesService_newInstance2_result {
 public:
  ...
  IPropertiesService_newInstance2_result() noexcept
                                         : success(0) {
  }
...
class IPropertiesService_setProperty_args {
 public:
  ...
  IPropertiesService_setProperty_args() noexcept
                                      : id(0),
                                        key(),
                                        value() {
  }
...
class IPropertiesService_setProperty_result {
 public:
  ...
  IPropertiesService_setProperty_result() noexcept
                                        : success() {
  }
...
class IPropertiesService_getProperty_args {
 public:
  ...
  IPropertiesService_getProperty_args() noexcept
                                      : id(0),
                                        key() {
  }
...
class IPropertiesService_getProperty_result {
 public:
  ...
  IPropertiesService_getProperty_result() noexcept
                                        : success() {
  }
...
class IPropertiesService_rmProperty_args {
 public:
  ...
  IPropertiesService_rmProperty_args() noexcept
                                     : id(0),
                                       key() {
  }
...
class IPropertiesService_rmProperty_result {
 public:
  ...
  IPropertiesService_rmProperty_result() noexcept
                                       : success() {
  }
...
class IPropertiesService_contains_args {
 public:
  ...
  IPropertiesService_contains_args() noexcept
                                   : id(0),
                                     key() {
  }
...
class IPropertiesService_contains_result {
 public:
  ...
  IPropertiesService_contains_result() noexcept
                                     : success(0) {
  }
...
class IPropertiesService_toMap_args {
 public:
  ...
  IPropertiesService_toMap_args(const IPropertiesService_toMap_args&) noexcept;
  IPropertiesService_toMap_args& operator=(const IPropertiesService_toMap_args&) noexcept;
  IPropertiesService_toMap_args() noexcept
                                : id(0),
                                  defaults(0) {
  }
...
class IPropertiesService_toMap_result {
 public:
  ...
  IPropertiesService_toMap_result() noexcept {
  }
...
class IPropertiesService_fromMap_args {
 public:
  ...
  IPropertiesService_fromMap_args() noexcept
                                  : id(0) {
  }
...
class IPropertiesService_fromMap_result {
 public:
  ...
  IPropertiesService_fromMap_result() noexcept {
  }
...
class IPropertiesService_load_args {
 public:
  ...
  IPropertiesService_load_args() noexcept
                               : id(0),
                                 path() {
  }
...
class IPropertiesService_load_result {
 public:
  ...
  IPropertiesService_load_result() noexcept {
  }
...
class IPropertiesService_store_args {
 public:
  ...
  IPropertiesService_store_args() noexcept
                                : id(0),
                                  path() {
  }
...
class IPropertiesService_store_result {
 public:
  ...
  IPropertiesService_store_result() noexcept {
  }
...
class IPropertiesService_clear_args {
 public:
  ...
  IPropertiesService_clear_args(const IPropertiesService_clear_args&) noexcept;
  IPropertiesService_clear_args& operator=(const IPropertiesService_clear_args&) noexcept;
  IPropertiesService_clear_args() noexcept
                                : id(0) {
  }
...
class IPropertiesService_clear_result {
 public:
  ...
  IPropertiesService_clear_result() noexcept {
  }
...
class IPropertiesServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  IPropertiesServiceProcessorFactory(const ::std::shared_ptr< IPropertiesServiceIfFactory >& handlerFactory) noexcept :
