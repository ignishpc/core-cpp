...
class IBackendServiceIfSingletonFactory : virtual public IBackendServiceIfFactory {
 public:
  ...
  virtual IBackendServiceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(IBackendServiceIf* /* handler */) override {}
...
class IBackendService_stop_args {
 public:
  ...
  IBackendService_stop_args(const IBackendService_stop_args&) noexcept;
  IBackendService_stop_args& operator=(const IBackendService_stop_args&) noexcept;
  IBackendService_stop_args() noexcept {
  }
...
class IBackendServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  IBackendServiceProcessorFactory(const ::std::shared_ptr< IBackendServiceIfFactory >& handlerFactory) noexcept :
