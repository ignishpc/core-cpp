...
IBackendService_stop_args::~IBackendService_stop_args() throw() {
}
...
IBackendService_stop_pargs::~IBackendService_stop_pargs() throw() {
}
...
IBackendService_stop_result::~IBackendService_stop_result() throw() {
}
...
IBackendService_stop_presult::~IBackendService_stop_presult() throw() {
}
...
::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > IBackendServiceProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< IBackendServiceIfFactory > cleanup(handlerFactory_);
  ::apache::thrift::stdcxx::shared_ptr< IBackendServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > processor(new IBackendServiceProcessor(handler));
  return processor;
}
