        ...
        namespace core {
            namespace modules {
                ...
                public:
                    ...
                    std::shared_ptr<storage::IObject> getIObject(size_t bytes);

                    std::shared_ptr<storage::IObject> getIObject(size_t bytes, size_t lines,
                                                                 std::shared_ptr<data::IManager<storage::IObject::Any>> m);
