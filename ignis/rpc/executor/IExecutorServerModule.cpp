...
IExecutorServerModule_updateProperties_args::~IExecutorServerModule_updateProperties_args() throw() {
}
...
IExecutorServerModule_updateProperties_pargs::~IExecutorServerModule_updateProperties_pargs() throw() {
}
...
IExecutorServerModule_updateProperties_result::~IExecutorServerModule_updateProperties_result() throw() {
}
...
IExecutorServerModule_updateProperties_presult::~IExecutorServerModule_updateProperties_presult() throw() {
}
...
IExecutorServerModule_stop_args::~IExecutorServerModule_stop_args() throw() {
}
...
IExecutorServerModule_stop_pargs::~IExecutorServerModule_stop_pargs() throw() {
}
...
IExecutorServerModule_stop_result::~IExecutorServerModule_stop_result() throw() {
}
...
IExecutorServerModule_stop_presult::~IExecutorServerModule_stop_presult() throw() {
}
...
IExecutorServerModule_test_args::~IExecutorServerModule_test_args() throw() {
}
...
IExecutorServerModule_test_pargs::~IExecutorServerModule_test_pargs() throw() {
}
...
IExecutorServerModule_test_result::~IExecutorServerModule_test_result() throw() {
}
...
IExecutorServerModule_test_presult::~IExecutorServerModule_test_presult() throw() {
}
...
::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > IExecutorServerModuleProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< IExecutorServerModuleIfFactory > cleanup(handlerFactory_);
  ::apache::thrift::stdcxx::shared_ptr< IExecutorServerModuleIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > processor(new IExecutorServerModuleProcessor(handler));
  return processor;
}
