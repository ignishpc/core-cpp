...
class IMathModuleIfSingletonFactory : virtual public IMathModuleIfFactory {
 public:
  ...
  virtual IMathModuleIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(IMathModuleIf* /* handler */) override {}
...
class IMathModuleNull : virtual public IMathModuleIf {
 public:
  ...
  void max1(const  ::ignis::rpc::ISource& /* cmp */) override {
    return;
  }
  void min1(const  ::ignis::rpc::ISource& /* cmp */) override {
    return;
  }
  void sampleByKey(const bool /* withReplacement */, const  ::ignis::rpc::ISource& /* fractions */, const int32_t /* seed */) override {
    return;
  }
...
class IMathModule_sample_args {
 public:
  ...
  IMathModule_sample_args() noexcept
                          : withReplacement(0),
                            seed(0) {
  }
...
class IMathModule_sample_result {
 public:
  ...
  IMathModule_sample_result() noexcept {
  }
...
class IMathModule_count_args {
 public:
  ...
  IMathModule_count_args(const IMathModule_count_args&) noexcept;
  IMathModule_count_args& operator=(const IMathModule_count_args&) noexcept;
  IMathModule_count_args() noexcept {
  }
...
class IMathModule_count_result {
 public:
  ...
  IMathModule_count_result() noexcept
                           : success(0) {
  }
...
class IMathModule_max_args {
 public:
  ...
  IMathModule_max_args(const IMathModule_max_args&) noexcept;
  IMathModule_max_args& operator=(const IMathModule_max_args&) noexcept;
  IMathModule_max_args() noexcept {
  }
...
class IMathModule_max_result {
 public:
  ...
  IMathModule_max_result() noexcept {
  }
...
class IMathModule_min_args {
 public:
  ...
  IMathModule_min_args(const IMathModule_min_args&) noexcept;
  IMathModule_min_args& operator=(const IMathModule_min_args&) noexcept;
  IMathModule_min_args() noexcept {
  }
...
class IMathModule_min_result {
 public:
  ...
  IMathModule_min_result() noexcept {
  }
...
class IMathModule_max1_args {
 public:
  ...
  IMathModule_max1_args() noexcept {
  }
...
class IMathModule_max1_result {
 public:
  ...
  IMathModule_max1_result() noexcept {
  }
...
class IMathModule_min1_args {
 public:
  ...
  IMathModule_min1_args() noexcept {
  }
...
class IMathModule_min1_result {
 public:
  ...
  IMathModule_min1_result() noexcept {
  }
...
class IMathModule_sampleByKey_args {
 public:
  ...
  IMathModule_sampleByKey_args() noexcept
                               : withReplacement(0),
                                 seed(0) {
  }
...
class IMathModule_sampleByKey_result {
 public:
  ...
  IMathModule_sampleByKey_result() noexcept {
  }
...
class IMathModule_countByKey_args {
 public:
  ...
  IMathModule_countByKey_args(const IMathModule_countByKey_args&) noexcept;
  IMathModule_countByKey_args& operator=(const IMathModule_countByKey_args&) noexcept;
  IMathModule_countByKey_args() noexcept {
  }
...
class IMathModule_countByKey_result {
 public:
  ...
  IMathModule_countByKey_result() noexcept {
  }
...
class IMathModule_countByValue_args {
 public:
  ...
  IMathModule_countByValue_args(const IMathModule_countByValue_args&) noexcept;
  IMathModule_countByValue_args& operator=(const IMathModule_countByValue_args&) noexcept;
  IMathModule_countByValue_args() noexcept {
  }
...
class IMathModule_countByValue_result {
 public:
  ...
  IMathModule_countByValue_result() noexcept {
  }
...
class IMathModuleProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  IMathModuleProcessorFactory(const ::std::shared_ptr< IMathModuleIfFactory >& handlerFactory) noexcept :
